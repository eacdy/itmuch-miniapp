...
<script>
  ...
  import {SHARE_POST_CONTRIBUTE_URL, SHARE_POST_PREVIEW_URL, SHARE_POST_URL} from "@/utils/api";
    ...
    methods: {
      async loadPreviewById() {
        ...
        let preview = await request(
          SHARE_POST_PREVIEW_URL + `/${this.id}`,
          'GET',
          {}
        );
        console.log('=======', preview);

        this.isOriginal = preview.isOriginal + '';
        this.title = preview.title;
        this.author = preview.author;
        this.price = preview.price;
        this.summary = preview.summary;
        this.downloadUrl = preview.downloadUrl;
      },
      ...
      async submit() {
        let post = await request(
          SHARE_POST_CONTRIBUTE_URL + `/${this.id}`,
          'PUT',
          {
